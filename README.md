...
**小猿口算（`com.fenbi.android.leo`）LSPosed 增强模块 · libxposed Modern API 102，由于作者开学项目已停摆，请加入交流群群主simianv2已发布https://github.com/z2010643575/Simian ，如果我有空也可能会继续更新，你们要我的vibe工作区我也能发。**
